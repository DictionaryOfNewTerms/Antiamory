# Project Configuration - Antiamory
...
echo $ANTIAMORY_SUPABASE_URL      # Required
echo $ANTIAMORY_SUPABASE_ACCESS_TOKEN  # Required for MCP
```
...
| **Credential File** | `~/.env.credentials/hobby.env` (shared) + `antiamory.env` (project-specific) |
